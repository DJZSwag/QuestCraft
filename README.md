...
# QuestCraft
![QuestCraft banner](/QCSimple3.jpg)
...
And boom! You have successfully installed QuestCraft on your VR headset! To play, simply press the **Play** button and wait for it to load, it might take a while depending on headset age and model. Note that 1.19.4 has launching issues and may not load.
...
- ### Vulkan
**[Vulkan](https://www.vulkan.org/)**, while being very fast, has low mod compatibility. Complex mods like Distant Horizons and Immersive Portals likely won't work.
...
- When installing mods that are not from Mod Manager on your Quest, you may face issues, ranging from unexpected behavior to crashes! If you experience any, please **[file an issue](https://github.com/QuestCraftPlusPlus/QuestCraft/issues/new/choose)** or visit the **[Discord server](discord.gg/questcraft)**!
